...
public class Population {
    ...
    private SmartRocket stage;

    public Population(SmartRocket pStage, double pMutationsrate, int pPopulationsgroesse, Vector2 pStartPosition, Ziel pZiel, int pLebenszeit) {
